...
void solve(ll testcase) {
    ...
    string s;
    getline(cin,s);
    set<string> arr({"Never gonna give you up","Never gonna let you down","Never gonna run around and desert you","Never gonna make you cry","Never gonna say goodbye","Never gonna tell a lie and hurt you","Never gonna stop"});
    for(i=0;i<n;i++){
        string s;
        getline(cin,s);

# [Platinum IV] 수열과 쿼리와 확률 1 - 33469 

[문제 링크](https://www.acmicpc.net/problem/33469) 
...
<ul>
	<li><code>1</code>: 모든 $A_i$에 대해 $A_i=A_i\times\frac{N+1-i}{N}$을 적용한다. 즉, $A_1,A_2,\cdots ,A_N$에 각각 $\frac{N}{N} ,\frac{N-1}{N} ,\cdots ,\frac{1}{N}$을 곱한다.</li>
...
<ul>
	<li><code>1</code>번 쿼리와 <code>2</code>번 쿼리 중 $\frac{1}{2}$의 동일한 확률로 어떤 종류의 쿼리를 적용할지 정한다.

	<ul>
		<li><code>2</code>번 쿼리를 정한 경우 가능한 $N$가지 쿼리에 대해 동일한 확률로 하나의 쿼리를 정한다.</li>
	</ul>
	</li>
	<li>정한 쿼리를 적용한다.</li>
</ul>

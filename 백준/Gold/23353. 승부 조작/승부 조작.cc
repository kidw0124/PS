...
void solve(ll testcase) {
    ...
    vector<vector<vector<ll>>>dp1(4,vector<vector<ll>>(n+2,vector<ll>(n+2)))
    ,dp2(4,vector<vector<ll>>(n+2,vector<ll>(n+2)));
    ...
    for(i=1;i<=n;i++){
        for(j=1;j<=n;j++){
            if(arr[i][j]==1) {
                dp1[0][i][j]=dp1[0][i-1][j]+1;
                dp1[1][i][j]=dp1[1][i][j-1]+1;
                dp1[2][i][j]=dp1[2][i-1][j-1]+1;
                dp1[3][i][j]=dp1[3][i-1][j+1]+1;
                dp2[0][i][j]=dp2[0][i-1][j]+1;
                dp2[1][i][j]=dp2[1][i][j-1]+1;
                dp2[2][i][j]=dp2[2][i-1][j-1]+1;
                dp2[3][i][j]=dp2[3][i-1][j+1]+1;
            }
            if(arr[i][j]==2){
                dp2[0][i][j]=dp1[0][i-1][j]+1;
                dp2[1][i][j]=dp1[1][i][j-1]+1;
                dp2[2][i][j]=dp1[2][i-1][j-1]+1;
                dp2[3][i][j]=dp1[3][i-1][j+1]+1;
            }
            ans=max({ans
                            ,dp1[0][i][j],dp1[1][i][j],dp1[2][i][j],dp1[3][i][j]
                            ,dp2[0][i][j],dp2[1][i][j],dp2[2][i][j],dp2[3][i][j]});
        }
    }
    cout<<ans;
}

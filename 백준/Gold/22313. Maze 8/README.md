# [Gold III] Maze 8 - 22313 

[문제 링크](https://www.acmicpc.net/problem/22313) 
...
<p>The file <a href="https://upload.acmicpc.net/d388e001-9e30-4412-8601-1bcae670f6c7/">field8.txt</a> represents a field of size 20x20. Create a maze for this field named <code>maze8.txt</code> that has a shortest path from the entrance to the core of length P. Your score for this subtask will be the minimum of 11 and 10<sup>P/95</sup>.</p>

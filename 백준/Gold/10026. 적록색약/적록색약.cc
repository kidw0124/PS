        ...
        for(j=0;j<n;j++){
            if(!vis[i][j]){
                ...
                while(!stk.empty()){
                    ...
                    for(ll k=0;k<4;k++){
                        ll nni=ni+dx[k],nnj=nj+dy[k];
                        if(nni<0||nnj<0||nni>=n||nnj>=n||vis[nni][nnj]||arr[i][j]!=arr[nni][nnj])continue;
                        else{
                            vis[nni][nnj]=1;
                            stk.push({nni,nnj});
                        }
            ...
            if(!vis2[i][j]){
                ...
                while(!stk.empty()){
                    ...
                    for(ll k=0;k<4;k++){
                        ll nni=ni+dx[k],nnj=nj+dy[k];
                        if(nni<0||nnj<0||nni>=n||nnj>=n||vis2[nni][nnj]||brr[i][j]!=brr[nni][nnj])continue;
                        else{
                            vis2[nni][nnj]=1;
                            stk.push({nni,nnj});
                        }

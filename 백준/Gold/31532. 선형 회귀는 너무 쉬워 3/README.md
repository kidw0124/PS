# [Gold III] 선형 회귀는 너무 쉬워 3 - 31532 

[문제 링크](https://www.acmicpc.net/problem/31532) 
...
<p>이 문제를 풀던 유림이는 너무 어려워서 동우에게 조금만 쉽게 바꿔 달라고 하자 동우는 조금 고민하다 다음과 같은 조건을 추가한다. ”$k=3$일 때만 구해. 그리고 $y$절편이 정해져 있을 때 기울기만 정해. 또, 모든 점의 $x$좌표는 양의 정수, $y$좌표도 정수라고 가정하자.”</p>
...
### 출력 
 ...
 <p>첫 번째 줄에 $f_3(a)$의 값이 $0$에 가장 가깝게 하는 $a$, 즉, $a_3$을 출력한다.</p>

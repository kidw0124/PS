# [Gold III] Maze 9 - 22314 

[문제 링크](https://www.acmicpc.net/problem/22314) 
...
<p>The file <a href="https://upload.acmicpc.net/2975f757-a2a3-4339-af12-e84f13e29ca6/">field9.txt</a> represents a field of size 11x21. Create a maze for this field named <code>maze9.txt</code> that has a shortest path from the entrance to the core of length P. Your score for this subtask will be the minimum of 11 and 10<sup>P/104</sup>.</p>
